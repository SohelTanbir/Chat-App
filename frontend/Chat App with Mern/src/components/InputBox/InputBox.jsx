...
const handleSubmit = (e)=>{
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className='flex items-center justify-between relative' >
              <input type="text" onChange={handleChange} onFocus={()=> setShowEmojiPicker(false)} className='w-[95%]   p-2 ps-12  rounded-md focus:outline-none' placeholder='Message to Michael' value={newMessage}/>
              <div className="emoji  absolute left-[12px] top-[8px] cursor-pointer " onClick={()=>setShowEmojiPicker(!showEmojiPicker)}>
