            ...
            <div className="flex justify-between">
                ...
                <div className="chats-body  w-full  relative">
                      ...
                      <div className="message-container h-[80vh] overflow-y-auto  px-5 py-4">
                        {
                            messages.length > 0 ?
                            messages.map(message =>  <Message key={message} text={message} sender={`${message.length > 10 ? 'friend':'me'}`} />)
                        :
                        <p className='w-full h-screen flex items-center justify-center text-2xl text-[#ddd]'>You don't have conversasion</p>
                        }
                      </div>
                     <InputBox/>
                </div>
